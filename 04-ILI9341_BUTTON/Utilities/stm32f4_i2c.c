...
/* Private functions */
void I2C1_INT_InitPins(I2C_PinsPack_t pinspack);
void I2C2_INT_InitPins(I2C_PinsPack_t pinspack);
void I2C3_INT_InitPins(I2C_PinsPack_t pinspack);
...
void I2C1_INT_InitPins(I2C_PinsPack_t pinspack) {
	...
	if (pinspack == I2C_PinsPack_1) {
		GPIO_InitAlternate(GPIOB, GPIO_Pin_6 | GPIO_Pin_7, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C1);
	}
#endif
#if defined(GPIOB)
	if (pinspack == I2C_PinsPack_2) {
		GPIO_InitAlternate(GPIOB, GPIO_Pin_8 | GPIO_Pin_9, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C1);
	}
#endif
#if defined(GPIOB)
	if (pinspack == I2C_PinsPack_3) {
		GPIO_InitAlternate(GPIOB, GPIO_Pin_6 | GPIO_Pin_9, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C1);
	}
#endif
...
#if defined(GPIOB)
	if (pinspack == I2C_PinsPack_1) {
		GPIO_InitAlternate(GPIOB, GPIO_Pin_10 | GPIO_Pin_11, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C2);
	}
#endif
#if defined(GPIOF)
	if (pinspack == I2C_PinsPack_2) {
		GPIO_InitAlternate(GPIOF, GPIO_Pin_0 | GPIO_Pin_1, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C2);
	}
#endif
#if defined(GPIOH)
	if (pinspack == I2C_PinsPack_3) {
		GPIO_InitAlternate(GPIOH, GPIO_Pin_4 | GPIO_Pin_5, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C2);
	}
#endif
	if (pinspack == I2C_PinsPack_Custom) {
		/* Init custom pins, callback function */
...
void I2C3_INT_InitPins(I2C_PinsPack_t pinspack) {
	...
	if (pinspack == I2C_PinsPack_1) {
		GPIO_InitAlternate(GPIOA, GPIO_Pin_8, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C3);
		GPIO_InitAlternate(GPIOC, GPIO_Pin_9, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C3);
	}
#endif
#if defined(GPIOH)
	if (pinspack == I2C_PinsPack_2) {
		GPIO_InitAlternate(GPIOH, GPIO_Pin_7 | GPIO_Pin_8, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Medium_Speed, GPIO_AF_I2C3);
	}
#endif
	if (pinspack == I2C_PinsPack_Custom) {
		/* Init custom pins, callback function */
