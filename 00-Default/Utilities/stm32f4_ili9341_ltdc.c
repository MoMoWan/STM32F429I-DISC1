...
void ILI9341_Init(void) {
	...
	ILI9341_CS_SET;
	/* Init SPI */
	SPI_Inits(ILI9341_SPI, ILI9341_SPI_PINS);
	/* Init SDRAM */
	SDRAM_Init();
...
void ILI9341_InitPins(void) {
	/* Init WRX pin */
	GPIO_Inits(ILI9341_WRX_PORT, ILI9341_WRX_PIN, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Medium_Speed);
	
	/* Init CS pin */
	GPIO_Inits(ILI9341_CS_PORT, ILI9341_CS_PIN, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Medium_Speed);

	/* GPIOA                     Blue5        VSYNC        Green2       Red4          Red5 */
	GPIO_InitAlternate(GPIOA, GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_6 | GPIO_Pin_11 | GPIO_Pin_12, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, GPIO_AF_LTDC);
	
	/* GPIOB                     Red3         Red6 */
	GPIO_InitAlternate(GPIOB, GPIO_Pin_0 | GPIO_Pin_1, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, 0x09);
	
	/* GPIOB                     Blue6		  Blue7        Green4        Green5 */
	GPIO_InitAlternate(GPIOB, GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10 | GPIO_Pin_11, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, GPIO_AF_LTDC);
	
	/* GPIOC                     HSYNC        Green6       Red2 */
	GPIO_InitAlternate(GPIOC, GPIO_Pin_6 | GPIO_Pin_7 | GPIO_Pin_10, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, GPIO_AF_LTDC);
	
	/* GPIOD                     Green7       Blue2 */
	GPIO_InitAlternate(GPIOD, GPIO_Pin_3 | GPIO_Pin_6 | GPIO_Pin_10, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, GPIO_AF_LTDC);
	
	/* GPIOF                     Enable */
	GPIO_InitAlternate(GPIOF, GPIO_Pin_10, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, GPIO_AF_LTDC);

	/* GPIOG                     Red7         DOTCLK       Blue3 */
	GPIO_InitAlternate(GPIOG, GPIO_Pin_6 | GPIO_Pin_7 | GPIO_Pin_11, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, GPIO_AF_LTDC);

	/* GPIOG                     Green3        Blue4 */
	GPIO_InitAlternate(GPIOG, GPIO_Pin_10 | GPIO_Pin_12, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_High_Speed, 0x09);
}
